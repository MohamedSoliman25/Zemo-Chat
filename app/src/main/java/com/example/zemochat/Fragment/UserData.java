...
import com.example.zemochat.Activity.DashBoard;
import com.example.zemochat.Constants.AllConstants;
import com.example.zemochat.Permissions.Permissions;
import com.example.zemochat.databinding.FragmentUserDataBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.imgPickImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //if user already allowed permission picImage
                if (permissions.isStorageOk(getContext()))
                    pickImage();
                else
                    //show default dialog for user to choice allow or deny
    ...
    private void uploadData() {
        ...
        storageReference.child(storagePath).putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                //for getting image uri that was storage in database storage for using it to store image uri in realtime database
...
// if user choice allow this method is calling and send request code
    @Override
...
// i use this method instead if implicit intent for taking image and also i use it for making cropp image
        CropImage.activity()
